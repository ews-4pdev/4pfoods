		    ...
		    <div class="modal-header">
		    	...
		    	<div class="margin">
		    		...
		    		<form id="nPassword" >
					    ...
					    <button class="btn btn-default btn-sm m-t-sm" id="reset" type="submit">Reset password</button>
					</form><!-- / end form -->
		    	</div><!-- /.margin -->
		    </div><!-- /.modal-content -->
		  </div><!-- /.modal-dialog -->
...
<div class="app-trigger" id="_Admin" rel='<?= json_encode(array('p' => 'login', 'sessionID' => session_id())); ?>'></div>
